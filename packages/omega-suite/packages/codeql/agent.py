...
class CodeQLAgent:
    ...
    def __init__(
        ...
        if out_dir:
            ...
            self.out_dir = LyrieConfig.BASE_OUT_DIR / f"codeql_{repo_name}_{timestamp}"
        ...
        logger.info(f"{'=' * 70}")
        logger.info("Lyrie OMEGA CODEQL AGENT")
        logger.info(f"{'=' * 70}")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Lyrie OMEGA CodeQL Agent - Autonomous CodeQL Security Analysis",
