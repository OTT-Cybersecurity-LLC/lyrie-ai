...
- ✅ Integration with Lyrie OMEGA core configuration
...
# Lyrie OMEGA output directory (optional)
export LYRIE_OUT_DIR=/custom/output/dir
```

### LyrieConfig Settings
...
The CodeQL package integrates seamlessly with Lyrie OMEGA's existing workflow:
...
```bash
# Run full Lyrie OMEGA pipeline with CodeQL
...
Part of the Lyrie OMEGA autonomous security testing framework.
